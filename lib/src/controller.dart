  ...
  Future<dynamic> _handleMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'marker#onDragStart':
        ...
        notifyListeners();
        break;
        // final LatLng marker = LatLng.fromJson(call.arguments['marker_position']);
        // if (marker != null) {
        //   onMarkerDragged(marker);
        // }
        // break;
      case 'marker#onDrag':          
        _markerPosition = LatLng.byJson(call.arguments['marker_position']);
        notifyListeners();
        break;  
        // final LatLng marker = LatLng.fromJson(call.arguments['marker_position']);
        // if (marker != null) {
      ...
      case 'marker#onDragEnd':
        ...
        final LatLng marker = LatLng.byJson(call.arguments['marker_position']);
        if (marker != null) {
          onMarkerDragged(marker);
        }
        break;
